...
SECRET_KEY = 'django-insecure-%upec_)uu=1a28tsspfet0l3ut1ftmaczbq#5xp&lwxxa9(dxv'
...
MEDIA_URL = 'media/'
# specifying the local file system path where the media files will be stored
